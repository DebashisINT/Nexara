package com.breezefieldsalesnexara.features.dashboard.presentation
...
import com.breezefieldsalesnexara.*
import com.breezefieldsalesnexara.R
import com.breezefieldsalesnexara.app.*
import com.breezefieldsalesnexara.app.NewFileUtils.browseDocuments
import com.breezefieldsalesnexara.app.NewFileUtils.browsePDFDocuments
import com.breezefieldsalesnexara.app.NewFileUtils.getExtension
import com.breezefieldsalesnexara.app.domain.*
import com.breezefieldsalesnexara.app.types.DashboardType
import com.breezefieldsalesnexara.app.types.FragType
import com.breezefieldsalesnexara.app.types.TopBarConfig
import com.breezefieldsalesnexara.app.uiaction.DisplayAlert
import com.breezefieldsalesnexara.app.utils.*
import com.breezefieldsalesnexara.app.utils.AppUtils.Companion.isProfile
...
import com.breezefieldsalesnexara.features.NewQuotation.*
import com.breezefieldsalesnexara.features.NewQuotation.api.GetQuotRegProvider
import com.breezefieldsalesnexara.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezefieldsalesnexara.features.SearchLocation.SearchLocationFragment
import com.breezefieldsalesnexara.features.SearchLocation.locationInfoModel
import com.breezefieldsalesnexara.features.TA.ViewAllTAListFragment
import com.breezefieldsalesnexara.features.achievement.AchievementFragment
import com.breezefieldsalesnexara.features.activities.presentation.*
import com.breezefieldsalesnexara.features.addAttendence.*
import com.breezefieldsalesnexara.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezefieldsalesnexara.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezefieldsalesnexara.features.addAttendence.model.GetReportToFCMResponse
import com.breezefieldsalesnexara.features.addAttendence.model.GetReportToResponse
import com.breezefieldsalesnexara.features.addAttendence.model.Leave_list_Response
import com.breezefieldsalesnexara.features.addorder.presentation.AddOrderFragment
...
import com.breezefieldsalesnexara.features.addshop.presentation.AddShopFragment
import com.breezefieldsalesnexara.features.addshop.presentation.OTPVerificationDialog
import com.breezefieldsalesnexara.features.addshop.presentation.ScanImageFragment
import com.breezefieldsalesnexara.features.addshop.presentation.ShowCardDetailsDialog
import com.breezefieldsalesnexara.features.alarm.model.AlarmData
import com.breezefieldsalesnexara.features.alarm.presetation.AttendanceReportFragment
import com.breezefieldsalesnexara.features.alarm.presetation.PerformanceReportFragment
import com.breezefieldsalesnexara.features.alarm.presetation.VisitReportDetailsFragment
import com.breezefieldsalesnexara.features.alarm.presetation.VisitReportFragment
import com.breezefieldsalesnexara.features.attendance.AttendanceFragment
import com.breezefieldsalesnexara.features.attendance.api.AttendanceRepositoryProvider
import com.breezefieldsalesnexara.features.attendance.model.AttendanceRequest
import com.breezefieldsalesnexara.features.attendance.model.AttendanceResponse
import com.breezefieldsalesnexara.features.averageshop.presentation.AverageShopFragment
import com.breezefieldsalesnexara.features.avgorder.presentation.AverageOrderFragment
import com.breezefieldsalesnexara.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezefieldsalesnexara.features.beatCustom.TeamBeatListFragment
import com.breezefieldsalesnexara.features.billing.presentation.AddBillingFragment
import com.breezefieldsalesnexara.features.billing.presentation.BillingDetailsFragment
import com.breezefieldsalesnexara.features.billing.presentation.BillingListFragment
import com.breezefieldsalesnexara.features.changepassword.presentation.ChangePasswordDialog
import com.breezefieldsalesnexara.features.chat.model.ChatListDataModel
import com.breezefieldsalesnexara.features.chat.model.ChatUserDataModel
import com.breezefieldsalesnexara.features.chat.model.GroupUserDataModel
import com.breezefieldsalesnexara.features.chat.presentation.*
import com.breezefieldsalesnexara.features.chatbot.presentation.ChatBotFragment
import com.breezefieldsalesnexara.features.chatbot.presentation.ChatBotShopListFragment
import com.breezefieldsalesnexara.features.chatbot.presentation.ReportsFragment
import com.breezefieldsalesnexara.features.chatbot.presentation.SelectLanguageDialog
import com.breezefieldsalesnexara.features.commondialog.presentation.CommonDialog
import com.breezefieldsalesnexara.features.commondialog.presentation.CommonDialogClickListener
import com.breezefieldsalesnexara.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezefieldsalesnexara.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezefieldsalesnexara.features.commondialogsinglebtn.OnDialogClickListener
import com.breezefieldsalesnexara.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezefieldsalesnexara.features.contacts.ActivityDtlsFrag
import com.breezefieldsalesnexara.features.contacts.AddOpptFrag
import com.breezefieldsalesnexara.features.contacts.ContactDtls
import com.breezefieldsalesnexara.features.contacts.ContactGr
import com.breezefieldsalesnexara.features.contacts.ContactsAddFrag
import com.breezefieldsalesnexara.features.contacts.ContactsFrag
import com.breezefieldsalesnexara.features.contacts.SchedulerAddFormFrag
import com.breezefieldsalesnexara.features.contacts.SchedulerViewFrag
import com.breezefieldsalesnexara.features.contacts.TemplateAddFrag
import com.breezefieldsalesnexara.features.contacts.TemplateViewFrag
import com.breezefieldsalesnexara.features.contacts.ViewCrmOpptFrag
import com.breezefieldsalesnexara.features.dailyPlan.prsentation.AllShopListFragment
import com.breezefieldsalesnexara.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezefieldsalesnexara.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezefieldsalesnexara.features.damageProduct.ShopDamageProductListFrag
import com.breezefieldsalesnexara.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezefieldsalesnexara.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezefieldsalesnexara.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezefieldsalesnexara.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezefieldsalesnexara.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezefieldsalesnexara.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezefieldsalesnexara.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezefieldsalesnexara.features.dashboard.presentation.model.ContentListResponseModel
import com.breezefieldsalesnexara.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezefieldsalesnexara.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezefieldsalesnexara.features.device_info.presentation.DeviceInfoListFragment
import com.breezefieldsalesnexara.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezefieldsalesnexara.features.document.DocumentRepoFeatureNewFragment
import com.breezefieldsalesnexara.features.document.presentation.DocumentListFragment
import com.breezefieldsalesnexara.features.document.presentation.DocumentTypeListFragment
import com.breezefieldsalesnexara.features.document.presentation.OpenFileWebViewFragment
import com.breezefieldsalesnexara.features.dymanicSection.presentation.AddDynamicFragment
import com.breezefieldsalesnexara.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezefieldsalesnexara.features.dymanicSection.presentation.DynamicListFragment
import com.breezefieldsalesnexara.features.dymanicSection.presentation.EditDynamicFragment
import com.breezefieldsalesnexara.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezefieldsalesnexara.features.home.presentation.HomeFragment
import com.breezefieldsalesnexara.features.homelocation.presentation.HomeLocationFragment
import com.breezefieldsalesnexara.features.homelocation.presentation.HomeLocationMapFragment
import com.breezefieldsalesnexara.features.know_your_state.KnowYourStateFragment
import com.breezefieldsalesnexara.features.lead.LeadFrag
import com.breezefieldsalesnexara.features.lead.ViewLeadFrag
import com.breezefieldsalesnexara.features.leaderboard.LeaderBoardFrag
import com.breezefieldsalesnexara.features.leaveapplynew.LeaveHome
import com.breezefieldsalesnexara.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezefieldsalesnexara.features.localshops.LocalShopListFragment
import com.breezefieldsalesnexara.features.localshops.LocalShopListMapFragment
import com.breezefieldsalesnexara.features.localshops.NearByShopsMapFragment
import com.breezefieldsalesnexara.features.location.*
import com.breezefieldsalesnexara.features.location.api.LocationRepoProvider
import com.breezefieldsalesnexara.features.location.model.*
import com.breezefieldsalesnexara.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezefieldsalesnexara.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezefieldsalesnexara.features.login.ShopFeedbackEntity
import com.breezefieldsalesnexara.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezefieldsalesnexara.features.login.presentation.LoginActivity
import com.breezefieldsalesnexara.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezefieldsalesnexara.features.logoutsync.presentation.LogoutSyncFragment
import com.breezefieldsalesnexara.features.marketAssist.MarketAssistTabFrag
import com.breezefieldsalesnexara.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezefieldsalesnexara.features.marketAssist.ShopListMarketAssistFrag
import com.breezefieldsalesnexara.features.marketing.presentation.MarketingPagerFragment
import com.breezefieldsalesnexara.features.meetinglist.prsentation.MeetingListFragment
import com.breezefieldsalesnexara.features.member.MapViewForTeamFrag
import com.breezefieldsalesnexara.features.member.model.TeamLocDataModel
import com.breezefieldsalesnexara.features.member.model.TeamShopListDataModel
import com.breezefieldsalesnexara.features.member.presentation.*
import com.breezefieldsalesnexara.features.menuBeat.MenuBeatFrag
import com.breezefieldsalesnexara.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezefieldsalesnexara.features.micro_learning.presentation.MicroLearningListFragment
import com.breezefieldsalesnexara.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezefieldsalesnexara.features.myallowancerequest.MyallowanceRequestFragment
import com.breezefieldsalesnexara.features.myjobs.model.CustomerDataModel
import com.breezefieldsalesnexara.features.myjobs.presentation.*
import com.breezefieldsalesnexara.features.mylearning.MyLearningFragment
import com.breezefieldsalesnexara.features.myorder.presentation.MyOrderListFragment
import com.breezefieldsalesnexara.features.myprofile.presentation.MyProfileFragment
import com.breezefieldsalesnexara.features.nearbyshops.api.ShopListRepositoryProvider
import com.breezefieldsalesnexara.features.nearbyshops.model.ShopData
import com.breezefieldsalesnexara.features.nearbyshops.model.ShopListResponse
import com.breezefieldsalesnexara.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezefieldsalesnexara.features.nearbyshops.presentation.BeatListFragment
import com.breezefieldsalesnexara.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezefieldsalesnexara.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezefieldsalesnexara.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezefieldsalesnexara.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezefieldsalesnexara.features.newcollection.CollectionDetailsStatusFragment
import com.breezefieldsalesnexara.features.newcollection.CollectionShopListFragment
import com.breezefieldsalesnexara.features.newcollection.NewCollectionListFragment
import com.breezefieldsalesnexara.features.newcollectionreport.*
import com.breezefieldsalesnexara.features.notification.NotificationFragment
import com.breezefieldsalesnexara.features.orderITC.CartListFrag
import com.breezefieldsalesnexara.features.orderITC.OrderListFrag
import com.breezefieldsalesnexara.features.orderITC.ProductListFrag
import com.breezefieldsalesnexara.features.orderITC.ViewNewOrdHisAllFrag
import com.breezefieldsalesnexara.features.orderITC.ViewNewOrdHistoryFrag
import com.breezefieldsalesnexara.features.orderITC.ViewOrdDtls
import com.breezefieldsalesnexara.features.orderList.NewDateWiseOrderListFragment
import com.breezefieldsalesnexara.features.orderList.NewOrderListFragment
import com.breezefieldsalesnexara.features.orderList.OrderListFragment
import com.breezefieldsalesnexara.features.orderdetail.presentation.OrderDetailFragment
import com.breezefieldsalesnexara.features.orderhistory.ActivityMapFragment
import com.breezefieldsalesnexara.features.orderhistory.OrderhistoryFragment
import com.breezefieldsalesnexara.features.orderhistory.TimeLineFragment
import com.breezefieldsalesnexara.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefieldsalesnexara.features.orderhistory.model.FetchLocationRequest
import com.breezefieldsalesnexara.features.orderhistory.model.FetchLocationResponse
import com.breezefieldsalesnexara.features.orderhistory.model.LocationData
import com.breezefieldsalesnexara.features.pendinglocationinout.PendingOutLocationFrag
import com.breezefieldsalesnexara.features.performance.GpsStatusFragment
import com.breezefieldsalesnexara.features.performance.PerformanceFragment
import com.breezefieldsalesnexara.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezefieldsalesnexara.features.performance.model.UpdateGpsInputParamsModel
import com.breezefieldsalesnexara.features.performanceAPP.OwnPerformanceFragment
import com.breezefieldsalesnexara.features.performanceAPP.PerformanceAppFragment
import com.breezefieldsalesnexara.features.performanceAPP.allPerformanceFrag
import com.breezefieldsalesnexara.features.permissionList.ViewPermissionFragment
import com.breezefieldsalesnexara.features.photoReg.*
import com.breezefieldsalesnexara.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezefieldsalesnexara.features.quotation.presentation.*
import com.breezefieldsalesnexara.features.reimbursement.presentation.*
import com.breezefieldsalesnexara.features.report.presentation.*
import com.breezefieldsalesnexara.features.returnsOrder.*
import com.breezefieldsalesnexara.features.settings.presentation.SettingsFragment
import com.breezefieldsalesnexara.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezefieldsalesnexara.features.shopdetail.presentation.*
import com.breezefieldsalesnexara.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldsalesnexara.features.stock.StockDetailsFragment
import com.breezefieldsalesnexara.features.stock.StockListFragment
import com.breezefieldsalesnexara.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefieldsalesnexara.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezefieldsalesnexara.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezefieldsalesnexara.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezefieldsalesnexara.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezefieldsalesnexara.features.stockCompetetorStock.CompetetorStockFragment
import com.breezefieldsalesnexara.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezefieldsalesnexara.features.survey.SurveyFrag
import com.breezefieldsalesnexara.features.survey.SurveyViewDtlsFrag
import com.breezefieldsalesnexara.features.survey.SurveyViewFrag
import com.breezefieldsalesnexara.features.task.presentation.AddTaskFragment
import com.breezefieldsalesnexara.features.task.presentation.CalenderTaskFragment
import com.breezefieldsalesnexara.features.task.presentation.EditTaskFragment
import com.breezefieldsalesnexara.features.task.presentation.TaskListFragment
import com.breezefieldsalesnexara.features.taskManagement.TaskManagementFrag
import com.breezefieldsalesnexara.features.taskManagement.ViewTaskManagementFrag
import com.breezefieldsalesnexara.features.timesheet.presentation.AddTimeSheetFragment
import com.breezefieldsalesnexara.features.timesheet.presentation.EditTimeSheetFragment
import com.breezefieldsalesnexara.features.timesheet.presentation.TimeSheetListFragment
import com.breezefieldsalesnexara.features.viewAllOrder.CartFragment
import com.breezefieldsalesnexara.features.viewAllOrder.OrderTypeListFragment
import com.breezefieldsalesnexara.features.viewAllOrder.ViewAllOrderListFragment
import com.breezefieldsalesnexara.features.viewAllOrder.ViewCartFragment
import com.breezefieldsalesnexara.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezefieldsalesnexara.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezefieldsalesnexara.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezefieldsalesnexara.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezefieldsalesnexara.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezefieldsalesnexara.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezefieldsalesnexara.features.viewPPDDStock.ViewOutstandingFragment
import com.breezefieldsalesnexara.features.viewPPDDStock.ViewPPDDListFragment
import com.breezefieldsalesnexara.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezefieldsalesnexara.features.viewPPDDStock.ViewStockFragment
import com.breezefieldsalesnexara.features.weather.presentation.WeatherFragment
import com.breezefieldsalesnexara.mappackage.MapActivity
import com.breezefieldsalesnexara.mappackage.MapActivityWithoutPath
import com.breezefieldsalesnexara.mappackage.SendBrod
import com.breezefieldsalesnexara.widgets.AppCustomEditText
...
import com.breezefieldsalesnexara.features.mylearning.LeaderboardLmsFrag
import com.breezefieldsalesnexara.features.mylearning.LmsQuestionAnswerSet
import com.breezefieldsalesnexara.features.mylearning.MyLearningAllVideoList
...
// val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezefieldsalesnexaralogsample/log").path);
            //27-09-2021
// val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesnexaralogsample/log").path);
...
// BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath = "/data/user/0/com.breezefieldsalesnexara/files/Fsmlog.html"
        ...
        try {
            ...
            val fileUrl1 = Uri.parse(
                File(
                    ...
                    "xbreezefieldsalesnexaralogsample/log"
                ).path
            );
            val fileUrl2 = Uri.parse(
                File(
                    Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                    "xbreezefieldsalesnexaralogsample/log.bak.1"
                ).path
            );
...
// return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root = File(
                Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                "xbreezefieldsalesnexaralogsample/log" + ".txt"
            )
            if (!root.exists()) {
                root.mkdirs()
            }
